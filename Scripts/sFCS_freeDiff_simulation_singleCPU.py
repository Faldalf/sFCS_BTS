...
#
# The code is based on "sFCS_freeDiff_simulation_parallel.py". 
...
# This script is a single CPU simulation version. 
#
...
out_path_tiff = 'C:\\Users\\User\\Desktop\\Desktop\\Temp\\'


print ('I see .... we are trying to simulate some diffusion on a single CPU ... Alright then... ')
...
for N in range (0,numofsimu):
    ...
    for cpm in maxphotonflux:
        ...
        for diff in D:
            ...
            data_store = tracks_to_int (total_sim_time,time_step,num_of_mol,diff, width, height, pos_y, pos_x, psf,cpm,steps_to_jump)
    ...
    print ('Elapsed time: ', np.str(time_elapsed),' seconds for one repetition (all cpm and D).')
